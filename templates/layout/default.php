...
<head>
    ...
    <?= $this->Html->css('optimized-styles') ?>
    
    <!-- Scripts -->
    <?= $this->Html->script('vendor/modernizr-2.8.3.min') ?>
    <?= $this->Html->script('vendor/jquery-1.12.4.min') ?>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="header-top-menu">
                        <ul class="nav navbar-nav notika-top-nav">
                            ...
                            <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><span><i class="notika-icon notika-support" style="padding-right: 28px;font-size: 16px"> <?= $username ?> / APE</i></span></a>
                            ...
                            <ul class="mobile-menu-nav">
                                <li><a data-toggle="collapse" data-target="#Charts" href="#">Home</a>
                                    <ul class="collapse dropdown-header-top">
                                        <li><?= $this->Html->link(__('Acceuil'), ['controller'=>'Users','action' => 'index']) ?>
                                    </ul>
                                </li>
                                <li><a data-toggle="collapse" data-target="#demoevent" href="#">Classes</a>
                                    <ul id="demoevent" class="collapse dropdown-header-top">
                                        <li><?= $this->Html->link(__('Liste Classes'), ['controller'=>'Ulcosalles','action' => 'classe']) ?></li>
                                        <li><?= $this->Html->link(__('Liste Elèves'), ['controller'=>'Ulcosalles','action' => 'classestudent']) ?></li>
                                    </ul>
                                </li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="mailbox" class="tab-pane notika-tab-menu-bg animated flipInX <?= $classes ?>">
                            <ul class="notika-main-menu-dropdown">
                                <li>
                                <?= $this->Html->link(__('Liste Classes'), ['controller'=>'Ulcosalles','action' => 'classe']) ?>
                                </li>
                                <li><?= $this->Html->link(__('Liste Elèves'), ['controller'=>'Ulcosalles','action' => 'classestudent']) ?>
                                </li>
                            </ul>
                        </div>
