...
<body>
   <div class="header-top-area">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="header-top-menu">
                        <ul class="nav navbar-nav notika-top-nav">
                            ...
                            <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><span><i class="notika-icon notika-support" style="padding-right: 28px;font-size: 16px"> <?= $username ?> / Prof</i></span></a>
                            ...
                            <ul class="mobile-menu-nav">
                                <li><a data-toggle="collapse" data-target="#Charts" href="#">Home</a>
                                    <ul class="collapse dropdown-header-top">
                                        <li><?= $this->Html->link(__('Acceuil'), ['controller'=>'Users','action' => 'prof']) ?></li>
                                        <li><?= $this->Html->link(__('Emplois du temps'), ['controller'=>'Users','action' => 'timet']) ?></li>
                                    </ul>
                                </li>
                                <li><a data-toggle="collapse" data-target="#demoevent" href="#">Classes</a>
                                    <ul id="demoevent" class="collapse dropdown-header-top">
                                         <li>
                                <?= $this->Html->link(__('Liste Classes'), ['controller'=>'Ulcosalles','action' => 'pclasse']) ?>
                                </li>
                                <li><?= $this->Html->link(__('Liste Elèves'), ['controller'=>'Ulcosalles','action' => 'pclassestudent']) ?>
                                </li>
                                    </ul>
                                </li>
                                <li><a data-toggle="collapse" data-target="#democrou" href="#">Notes</a>
                                    <ul id="democrou" class="collapse dropdown-header-top">
                                         <li><?= $this->Html->link(__('Gestion des notes'), ['controller'=>'Ulcosalles','action' => 'noteclassestudent']) ?>
                                </li>
                               <?php /*?> <li><?= $this->Html->link(__('Editer les notes'), ['controller'=>'Ulcosalles','action' => 'enoteclassestudent']) ?>
                                </li><?php */?>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="<?= $prof ?>"><a data-toggle="tab" href="#Interface"><i class="notika-icon notika-edit"></i>Notes</a>
                        </li>
                    </ul>
                    <div class="tab-content custom-menu-content">
                        <div id="Home" class="tab-pane in <?= $home ?> notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><?= $this->Html->link(__('Acceuil'), ['controller'=>'Users','action' => 'prof']) ?>
                                </li>
                                <li><?= $this->Html->link(__('Emplois du temps'), ['controller'=>'Users','action' => 'timet']) ?>
                                </li>
                                </li>
                            </ul>
                        </div>
    ...
    <?= $this->Html->script(['vendor/jquery-1.12.4.min','bootstrap.min','wow.min','jquery-price-slider','owl.carousel.min','jquery.scrollUp.min','meanmenu/jquery.meanmenu','counterup/jquery.counterup.min','counterup/waypoints.min','counterup/counterup-active','scrollbar/jquery.mCustomScrollbar.concat.min','jvectormap/jquery-jvectormap-2.0.2.min','jvectormap/jquery-jvectormap-world-mill-en','jvectormap/jvectormap-active','sparkline/jquery.sparkline.min.js','sparkline/sparkline-active.js','flot/jquery.flot','flot/jquery.flot.resize','flot/jquery.flot.pie','flot/jquery.flot.tooltip.min','','flot/jquery.flot.orderBars','flot/curvedLines','flot/flot-active','knob/jquery.knob','knob/jquery.appear','knob/knob-active','flot/flot-widget-anatic-active','wave/waves.min','wave/wave-active','dialog/sweetalert2.min','dialog/dialog-active','chat/moment.min','chat/jquery.chat','todo/jquery.todo','plugins','data-table/jquery.dataTables.min','data-table/data-table-act','main','bootstrap-select/bootstrap-select','jquery3-7']) ?>
