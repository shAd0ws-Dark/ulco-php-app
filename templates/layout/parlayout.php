                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="header-top-menu">
                        <ul class="nav navbar-nav notika-top-nav">
                            ...
                            <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><span><i class="notika-icon notika-support" style="padding-right: 28px;font-size: 16px"> <?= $username ?> / Parent</i></span></a>
                    ...
                    <div class="tab-content custom-menu-content">
                        <div id="Home" class="tab-pane in <?= $home ?> notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><?= $this->Html->link(__('Acceuil'), ['controller'=>'Users','action' => 'paren']) ?>
                                </li>
                            </ul>
                        </div>                    
