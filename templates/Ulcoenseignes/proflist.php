                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?= $count=$count+1; ?></td>
                                        <td>
                                        <?= $this->Html->link(ucwords($listprof->ulcoprof->Nom.' '.$listprof->ulcoprof->Prenom), ['controller'=>'Ulcoprofs','action' => 'profdetail', $listprof->ulcoprof->id,$listprof->ulcosalle_id]) ?>
                                        </td>
                       ...
                       <div class="recent-items-wp notika-shadow sm-res-mg-t-30">
                        <div class="rc-it-ltd">
                           ...
                           <?php foreach ($ulcosalles as $ulcosalle): ?>
                            ...
                            <?= $this->Html->link(__(h($ulcosalle->libele)), ['controller'=>'Ulcoenseignes','action' => 'proflist',$ulcosalle->id], ['class'=>'btn notika-btn-lime','escapeTitle' =>false]) ?>
                            <?php endforeach; ?>
                        </div>
...
$(function(){
    $(".smslink").click(function(){
     ...
     sms = $(this).data('sms')+'\n'+'<?= strtoupper($listprof->ulcoprof->Matricul)?>';
