...
<p><em>Cliquez sur une salle de classe pour avoir la liste des élèves de cette salle</em></p>
						</div>
                        <div class="material-design-btn">
                           <?php foreach ($ulcosalles as $ulcosalle): ?>
                            
                            <?= $this->Html->link(__(h($ulcosalle->ulcosalle->libele)), ['controller'=>'Ulcostudents','action' => 'pstudentlist',$ulcosalle->ulcosalle->id], ['class'=>'btn notika-btn-teal','escapeTitle' =>false]) ?>
                            <?php endforeach; ?>
                        </div>
                    </div>
