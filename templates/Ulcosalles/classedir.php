...
<p><em>Cliquez sur une classe pour avoir les détails et performances de cette classe </em></p>
						</div>
                        <div class="material-design-btn">
                           <?php foreach ($ulcosalles as $ulcosalle): ?>
                            
                            <?= $this->Html->link(__(h($ulcosalle->libele)), ['action' => 'detailclassedir',$ulcosalle->id], ['class'=>'btn notika-btn-lightblue','escapeTitle' =>false]) ?>
                            <?php endforeach; ?>
                        </div>
                    </div>
