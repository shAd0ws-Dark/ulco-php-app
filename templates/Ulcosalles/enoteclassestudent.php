...
<p><em>Cliquez sur une salle de classe pour <strong>modifier les notes</strong></em></p>
                        ...
                        <div class="material-design-btn">
                           <?php foreach ($ulcosalles as $ulcosalle): ?>
                            ...
                            <?= $this->Html->link(__(h($ulcosalle->ulcosalle->libele)), ['controller'=>'Ulcostudents','action' => 'enotestudentlist',$ulcosalle->ulcosalle->id], ['class'=>'btn notika-btn-teal','escapeTitle' =>false]) ?>
                            <?php endforeach; ?>
                        </div>
                    </div>
