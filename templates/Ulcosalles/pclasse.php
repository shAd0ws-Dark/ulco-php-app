...
<div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="btn-demo-notika mg-t-30">
						<div class="notika-btn-hd">
							<h2>Vos classes</h2>
<p><em>Cliquez sur une classe pour avoir votres performances dans cette salles</em></p>
						</div>
                        <div class="material-design-btn">
                           <?php foreach ($ulcosalles as $ulcosalle): ?>
                            
                            <?= $this->Html->link(__(h($ulcosalle->ulcosalle->libele)), ['action' => 'pdetailclasse',$ulcosalle->ulcosalle->id], ['class'=>'btn notika-btn-lightblue','escapeTitle' =>false]) ?>
                            <?php endforeach; ?>
                        </div>
                    </div>
                        ...
                        <div class="rc-it-ltd">
                            <div class="recent-items-ctn">
                                <div class="recent-items-title">
                                    <h2>Vos performances par salle</h2>
                                </div>
                            </div>
                            <div class="skill">
                                <?php 
