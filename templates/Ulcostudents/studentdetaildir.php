              ...
              <div class="row">
                  <div class="col-lg-12 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <div class="nk-int-st">
                                        <h2><?= h($ulcostudent->Matricul) ?> / <?= $this->Html->link(__(h($nomsalle)), ['controller'=>'Ulcostudents','action' => 'studentlistdir',$idsalle], ['escapeTitle' =>false]) ?></h2>
                ...
                $colorbar='nk-red';
                                ...
                                <div class="progress">
                                    <div class="lead-content">
                                        <p>
                                        <?= $this->Html->link(($mtnote->ulcomatiere->libele), ['controller'=>'Ulcostudents','action' => 'matieredetaildir',$ulcostudent->id,$mtnote->ulcomatiere_id,1]) ?>
                                    </p>
            ...
            elseif($percentagemarkss2<50){
                $colorbars2='nk-red';
                                ...
                                <div class="progress">
                                    <div class="lead-content">
                                        <p>
                                        <?= $this->Html->link(($mtnotes2->ulcomatiere->libele), ['controller'=>'Ulcostudents','action' => 'matieredetaildir',$ulcostudent->id,$mtnotes2->ulcomatiere_id,2]) ?>
                                    </p>
            ...
            elseif($percentagemarkss3<50){
                $colorbars3='nk-red';
                                ...
                                <div class="progress">
                                    <div class="lead-content">
                                        <p>
                                        <?= $this->Html->link(($mtnotes3->ulcomatiere->libele), ['controller'=>'Ulcostudents','action' => 'matieredetaildir',$ulcostudent->id,$mtnotes3->ulcomatiere_id,3]) ?>
                                    </p>
