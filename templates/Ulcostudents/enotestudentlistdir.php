...
<div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="btn-demo-notika mg-t-30">
						<div class="notika-btn-hd">
							<h2>Listing Elèves/MODIFICATIO DES NOTES <?= $nomsalle; ?></h2>
                            <em>En cas d'erreur, vous pouvez modifier la note</em>
                    </div>
                        <br>
                       ...
                       <div class="recent-items-wp notika-shadow sm-res-mg-t-30">
                        <div class="rc-it-ltd">
                          ...
                          <?php foreach ($profsalles as $profsalle): ?>
                            ...
                            <?= $this->Html->link(__(h($profsalle->libele)), ['controller'=>'Ulcostudents','action' => 'enotestudentlistdir',$profsalle->id], ['class'=>'btn notika-btn-teal','escapeTitle' =>false]) ?>
                            <?php endforeach; ?>
                        </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                               <h2 id="smstitle"></h2>
                                                ...
                                                <strong>Trimestre:</strong> <span><em id="tri"></em></span><br><br>
                                                <strong>Note actuelle:</strong> <span><em id="anote"></em></span><br>
                                                </p>
                                                <p>
                                                <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="nk-int-st">
                                       ...
                                       <!-- <label class="nk-label">Entrez la note/ 20</label>-->
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn notika-btn-green ff" data-dismiss="modalm" style="color: white">MISE A JOUR</button>
...
$(function(){
   ...
   $(".ff").click(function(){
       ...
       $.ajax({
			type: "POST",
			url:"<?= $this->url->build(['controller'=>'Ulcostudents','action'=>'enotedir']) ?>",
			data:{matiereid:matiereid,sq:sq,trim:trim,salleid:salleid,studentid:studentid,note:note,test:'test'},
			headers:{
    ...
    function checknote(){
         ...
         $.ajax({
			type: "POST",
			url:"<?= $this->url->build(['controller'=>'Ulcostudents','action'=>'enotedir']) ?>",
			data:{matiereid:matiereid,sq:sq,trim:trim,salleid:salleid,studentid:studentid},
			headers:{
				'X-CSRF-Token':$('[name="_csrfToken"]').val()
				},
			success:function(data){
          ...
          if(exist==='ok'){
            ...
            document.getElementById("suj").innerHTML=chapitre;
            document.getElementById("anote").innerHTML=lanote;
            $("#notes").val(lanote);
                }
                
                 else if(exist==='no'){
                    
                  alert('Note inexistante\nAllez à Gestion des note et ajouter cette note')
                     $("#myModaltwo").modal('hide');
                }
