...
<div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="btn-demo-notika mg-t-30">
                       ...
                       <em style="font-size: 13px">Cliquez sur la matière pour avoir plus de détails</em>     
                    </div>
              <br>
            ...
            $notes1=($mtnotes1->totalmarks*20)/$maxnote;
                ...
                $colorbar='nk-red';
                                ...
                                <div class="progress">
                                    <div class="lead-content">
                                        <p>
                                        <?= $this->Html->link(($mtnotes1->ulcomatiere->libele), ['controller'=>'Ulcostudents','action' => 'parstudperformdetail',$ulcostudent->id,$mtnotes1->ulcomatiere_id,1]) ?>
                                    </p>
                                        
                                          
                                    </div>
                                    <div class="<?= $colorbar ?> progress-bar wow fadeInLeft" data-progress="<?= $percentagemarks ?>%" style="width: <?= $percentagemarks ?>%;" data-wow-duration="1s" data-wow-delay="1s"><span><?= number_format($notes1,2) ?>/20</span></div>
                                </div>
                               <?php endforeach; ?>
                            </div>
                                                </div>
            ...
            $notes2=($mtnotes2->totalmarks*20)/$maxnotes2;
            ...
            elseif($percentagemarkss2<50){
                $colorbars2='nk-red';
                                ...
                                <div class="progress">
                                    <div class="lead-content">
                                        <p>
                                        <?= $this->Html->link(($mtnotes2->ulcomatiere->libele), ['controller'=>'Ulcostudents','action' => 'parstudperformdetail',$ulcostudent->id,$mtnotes2->ulcomatiere_id,2]) ?>
                                    </p>
                                    ...
                                    <div class="<?= $colorbars2 ?> progress-bar wow fadeInLeft" data-progress="<?= $percentagemarkss2 ?>%" style="width: <?= $percentagemarkss2 ?>%;" data-wow-duration="1s" data-wow-delay="1s"><span><?= number_format($notes2,2) ?>/20</span></div>
                                </div>
                               <?php endforeach; ?>
                            </div>
                                                </div>
            ...
            $notes3=($mtnotes3->totalmarks*20)/$maxnotes3;
            }
            ...
            elseif($percentagemarkss3<50){
                $colorbars3='nk-red';
                                ...
                                <div class="progress">
                                    <div class="lead-content">
                                        <p>
                                        <?= $this->Html->link(($mtnotes3->ulcomatiere->libele), ['controller'=>'Ulcostudents','action' => 'parstudperformdetail',$ulcostudent->id,$mtnotes3->ulcomatiere_id,3]) ?>
                                    </p>
                                    ...
                                    <div class="<?= $colorbars3 ?> progress-bar wow fadeInLeft" data-progress="<?= $percentagemarkss3 ?>%" style="width: <?= $percentagemarkss3 ?>%;" data-wow-duration="1s" data-wow-delay="1s"><span><?= number_format($notes3,2) ?>/20</span></div>
                                </div>
                               <?php endforeach; ?>
                            </div>
                                                </div>
            ...
            elseif($percentagemarks<50){
                $colorbar='nk-red';
                                ...
                                <div class="progress">
                                    <div class="lead-content">
                                        <p>
                                        <?= $this->Html->link(($mtnote->ulcosalle->libele), ['action' => 'parstudperformsalle',$mtnote->ulcosalle->id]) ?>
                                    </p>
