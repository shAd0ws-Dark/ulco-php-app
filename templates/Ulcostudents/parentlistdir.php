...
<div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="btn-demo-notika mg-t-30">
						<div class="notika-btn-hd">
							<h2>Listing Parents <?= $nomsalle; ?></h2>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?= $count=$count+1; ?></td>
                                        <td>
                                        <?= $this->Html->link(ucwords($ulcostudent->ulcoparent->Nompere.' '.$ulcostudent->ulcoparent->Prenompere), ['action' => 'studentdetaildir', $ulcostudent->id]) ?>
                                        </td>
