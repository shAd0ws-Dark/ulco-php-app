                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="bootstrap-select fm-cmp-mg">
                                    <select class="form-control selectpicker mati">
...
$(function(){
   ...
   $(".ff").click(function(){
       ...
       $.ajax({
			type: "POST",
			url:"<?= $this->url->build(['controller'=>'Ulcostudents','action'=>'enote']) ?>",
			data:{matiereid:matiereid,sq:sq,trim:trim,idprof:idprof,salleid:salleid,studentid:studentid,note:note,test:'test'},
			headers:{
    ...
    function checknote(){
         ...
         $.ajax({
			type: "POST",
			url:"<?= $this->url->build(['controller'=>'Ulcostudents','action'=>'enote']) ?>",
			data:{matiereid:matiereid,sq:sq,trim:trim,idprof:idprof,salleid:salleid,studentid:studentid},
			headers:{
				'X-CSRF-Token':$('[name="_csrfToken"]').val()
				},
			success:function(data){
