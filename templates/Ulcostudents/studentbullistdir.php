...
<div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="btn-demo-notika mg-t-30">
						<div class="notika-btn-hd">
							<h2>Génération des bulletins / <em style="font-weight: 300"><?= $nomsalle; ?></em></h2>
<br><p><em>Cliquez sur le nom de l'élève pour générer son bulletin</em></p>
                    </div>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?= $count=$count+1; ?></td>
                                        <td>
                                        <?= $this->Html->link(ucwords($ulcostudent->Nom.' '.$ulcostudent->Prenom), ['controller'=>'Ulcostudents','action' => 'bulletin', $ulcostudent->id]) ?>
                                        </td>
